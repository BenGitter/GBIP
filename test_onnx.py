...
# # model = onnx.load_model('gbip_model.onnx')
# # print(calculate_macs(model))
# print('---   onnx_tool   ---')
# # onnx_tool.model_profile('./data/yolov7-tiny.onnx')
# onnx_tool.model_profile('gbip_model.onnx')
