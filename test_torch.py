...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1:
        # sys.argv.append('yolov7.pth')
        # sys.argv.append('C:\\Users\\benja\\Desktop\\k1015.pth')
        sys.argv.append('../saved_models/GBIP/experiments_full/update_lr/k1015/best1.pth')
    ...
    print('FPR: {:.3f} \t #params: {}'.format(num_flops / 106.47, num_params))
    # exit()
    ...
    imgsz = 640
    testloader = create_dataloader(data_dict['test'], imgsz, batch_size, gs, hyp=hyp, 
